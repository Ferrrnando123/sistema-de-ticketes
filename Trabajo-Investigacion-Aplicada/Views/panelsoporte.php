...
<body class="bg-[#f1f5f9] font-sans text-slate-900">
    ...
    <main class="max-w-7xl mx-auto mt-10 px-6 pb-20">
        ...
        <div class="mb-8">
            ...
            <p class="text-slate-500 mt-2 text-lg">Vista global de incidencias, priorización y gestión de tickets de usuario.</p>
        </div>
        ...
        <div class="bg-white rounded-3xl shadow-xl shadow-slate-200/60 border border-slate-100 overflow-hidden">
            <div class="p-6 border-b border-slate-100 flex justify-between items-center bg-slate-50/30">
                <h3 class="font-bold text-slate-700 uppercase text-xs tracking-widest">Todos los tickets registrados</h3>
                    ...
                    <tbody class="divide-y divide-slate-50">
                        <tr class="hover:bg-slate-50 transition-colors group">
                            ...
                            <td class="px-8 py-5 text-center">
                                <span class="px-2.5 py-1 rounded text-[10px] font-black uppercase bg-red-50 text-red-600 border border-red-200">Crítica</span>
                            </td>
                            <td class="px-8 py-5 text-center">
                            ...
                            <td class="px-8 py-5 text-right">
                                <div class="flex justify-end gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                                    <button title="Asignar" class="w-8 h-8 rounded-lg border border-slate-200 text-slate-400 hover:text-cyan-500 hover:border-cyan-200 transition-all">
