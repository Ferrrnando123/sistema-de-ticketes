    ...
    <nav class="bg-[#1e293b] text-white shadow-lg px-8 py-3">
        <div class="max-w-7xl mx-auto flex justify-between items-center">
            ...
            <div class="hidden md:flex space-x-8 items-center text-sm">
                ...
                <a href="#" class="text-cyan-400 font-semibold border-b-2 border-cyan-400 pb-1">Mis Tickets</a>
                <a href="#" class="text-slate-400 hover:text-white transition">Panel Soporte</a>
